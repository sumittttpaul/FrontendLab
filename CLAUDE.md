...
> **See also:** [AGENTS.md](./AGENTS.md) for the master development guide.

## Project Context

You are working on **SumitApp**, a production-grade CLI tool and monorepo template system.

**Codebases in this repo:**

1.  `create-sumit-app/` (The CLI Tool)
2.  `official-site/` (The Docs Site)
3.  `templates/default/` (The Monorepo Template)
...
- **Config:** `"packageManager": "bun@1.2.22"`
- **Commands:** Use `bun run dev`, `bun test`, etc.
...
Remember: SumitApp is designed to provide developers with a **production-ready foundation** that just works, while maintaining the **flexibility to
