...
#
# =====================================
# SumitApp Specific Commands
# =====================================
# CLI Tool
#   cd create-sumit-app && bun dev
#   cd create-sumit-app && bun build
#   bun run create-sumit-app/dist/index.js test-app
#
# Documentation Site
#   cd official-site && bun dev
#
# Template Testing
#   npx create-sumit-app test-project
#
# =====================================
# Generic Reference Below
# =====================================
