...
export function Keyword({ children }: React.PropsWithChildren) {
  return (
    <div className="flex w-full flex-col items-center justify-center gap-y-4 rounded-lg border bg-[oklch(0.95_0_0)] pt-1 pr-2 pb-3 pl-4 max-[56rem]:rounded-none dark:bg-[oklch(0.18_0_0)]">
