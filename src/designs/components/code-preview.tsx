...
export function CodePreview({ children }: React.PropsWithChildren) {
  return (
    <div className="bg-background relative flex w-full max-w-[calc(100vw-2rem)]">
      <div className="relative w-full overflow-hidden rounded-lg bg-black/4 bg-[radial-gradient(var(--pattern-fg)_1px,transparent_0)] bg-size-[10px_10px] bg-fixed pt-8 pl-8 [--pattern-fg:var(--color-black)]/5 after:pointer-events-none after:absolute after:inset-0 after:rounded-lg after:inset-ring after:inset-ring-black/5 max-sm:pt-4 max-sm:pl-4 dark:bg-white/4 dark:[--pattern-fg:var(--color-white)]/10 dark:after:inset-ring-white/10">
        <div className="outline-l-none size-full rounded-tl-xl bg-[oklch(0_0_0)] pt-1 pl-2 outline outline-[color-mix(in_oklab,var(--color-white)_10%,transparent)]">
